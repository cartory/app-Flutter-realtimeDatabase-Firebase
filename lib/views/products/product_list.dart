...
class _ProductListState extends State<ProductList> {
  ...
  Widget _firebaseAnimatedList() {
    return FirebaseAnimatedList(
        ...
        defaultChild: Center(child: Image.asset('assets/jar-loading.gif', width: double.infinity,))
    );
  }
  ...
  Widget _productItem(Product product) {
    return Dismissible(
      ...
      child: InkWell(
        ...
        onTap: () =>
            Navigator.pushNamed(context, 'productForm', arguments: product),
      ),
      onDismissed: (direction) => provider.destroy(product.id),
    );
  }
